...
function isValidMedia(candidate: string, opts?: { allowSpaces?: boolean }) {
  ...
  // Allow absolute paths within the OpenClaw media directory (e.g., from browser screenshots).
  // This is safe because these paths are generated by OpenClaw itself.
  if (candidate.startsWith("/")) {
    const mediaDir = getMediaDir();
    if (candidate.startsWith(mediaDir + "/") && !candidate.includes("..")) {
      return true;
    }
  }
